...
namespace NFMarketReplayRecorder.ATAS
{
    /// <summary>
    ...
    /// behaviour in <c>NFMarketReplayRecorder.Core</c>, which is fully tested, so a
    ...
    // in stub builds too.
    [DisplayName("NF Market Replay Recorder")]
    public class MarketReplayRecorderIndicator : Indicator, IDomSource
    {
        ...
        public string OutputDirectory { get; set; } =
            Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "NFMarketReplayRecorder");
        ...
        public MarketReplayRecorderIndicator()
        {
